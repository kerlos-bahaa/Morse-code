...
```sh
cd my-folder
git clone https://github.com/kerlos-bahaa/Morse-code.git
```
...
Feel free to check the [issues page](https://github.com/kerlos-bahaa/Morse-code/issues)
...
We would like to express our sincere gratitude to [Microverse](https://github.com/microverseinc), the dedicated reviewers, and collaborators. Your unwavering support, feedback, and collaborative efforts have played an immense role in making this journey a resounding success. We are truly grateful for your contributions and for being an integral part of our achievements.
